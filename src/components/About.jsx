  ...
  return (
    <div className="bg-black text-white py-20" id="about">
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        ...
        {/* Skills Section - Box Layout with Colors */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-center">
          {/* Frontend Skills */}
          <div className="p-6 rounded-lg shadow-lg bg-gradient-to-r from-blue-500 to-purple-500">
          ...
          {/* Backend Skills */}
          <div className="p-6 rounded-lg shadow-lg bg-gradient-to-r from-green-500 to-teal-500">
          ...
          <div className="p-6 rounded-lg shadow-lg bg-gradient-to-r from-yellow-500 to-orange-500">
