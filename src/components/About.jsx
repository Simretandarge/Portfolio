    ...
    <div className="bg-black text-white py-20" id="about">
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-center">
          {/* Frontend Skills */}
          <div className="p-6 rounded-lg shadow-lg bg-gradient-to-r from-purple-500 to-blue-500 transform transition-transform duration-300 hover:scale-105">
          ...
          <div className="p-6 rounded-lg shadow-lg bg-gradient-to- from-blue-500 to-green-500 transform transition-transform duration-300 hover:scale-105">
